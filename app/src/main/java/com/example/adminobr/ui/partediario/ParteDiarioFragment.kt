...
class ParteDiarioFragment : Fragment() {
    ...
    private lateinit var parteDiario: ListarPartesDiarios
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Recibir el argumento con Safe Args
        parteDiario = ParteDiarioFragmentArgs.fromBundle(requireArguments()).parteDiario
